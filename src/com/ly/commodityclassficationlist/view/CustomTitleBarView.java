...
public class CustomTitleBarView extends RelativeLayout {
	...
	public CustomTitleBarView(Context context, AttributeSet attrs, int defStyle) {
		...
		leftType = ta.getInt(R.styleable.barView_leftTypeTitle, -1);
		rightType = ta.getInt(R.styleable.barView_rightTypeTitle, -1);
		centerType = ta.getInt(R.styleable.barView_centerTypeTitle, -1);
		...
		initXmlCenterLayoutParams();
			...
			case LEFT_TYPE_IMAGE:
				...
				leftView = leftImage;
				if (ta.getResourceId(R.styleable.barView_leftImageSourceTitle,-1)!=-1) {
			...
			case LEFT_TYPE_TEXT:
				...
				if (ta.getString(R.styleable.barView_leftTextTitle) != null) {
		...
		case RIGHT_TYPE_IMAGE:
			...
			if (ta.getResourceId(R.styleable.barView_rightImageSourceTitle,-1)!=-1) {
		...
		case RIGHT_TYPE_TEXT:
			...
			if (ta.getString(R.styleable.barView_rightTextTitle) != null) {
		...
		case CENTER_TYPE_TEXT:
			...
			if (ta.getString(R.styleable.barView_centerTextTitle) == null) {
	...
	private void initEvent(final View leftView, final View rightView) {
		if (leftView != null) {
			leftView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (mListener != null) {
						leftView.setId(v.getId());
						mListener.onBarViewClick(CustomTitleBarView.this, -1);
					}
		...
		if (rightView != null) {
			rightView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (mListener != null) {
						mListener.onBarViewClick(CustomTitleBarView.this, -2);
					}
	...
	private void initCenterText(TypedArray ta, Context context) {
		centerText = ta.getString(R.styleable.barView_centerTextTitle);
		if (centerText == null) {
			centerText = "请设置文字";
		}
		centerTextColor = ta.getColor(R.styleable.barView_centerTextColorTitle,
				Color.BLACK);

		centerTextSize = ta.getDimension(R.styleable.barView_centerTextSizeTitle,
				14.0f);
		...
		centerTextPadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_centerTextPaddingTitle, 0));
		centerTextPaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_centerTextPaddingLeftTitle, 0));
		// System.out.println(leftTextPaddingLeft+"<><>");
		centerTextPaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_centerTextPaddingRightTitle, 0));
		centerTextPaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_centerTextPaddingTopTitle, 0));
		centerTextPaddingBottom = DensityUtils
				.px2dp(context, ta.getDimension(
						R.styleable.barView_centerTextPaddingBottomTitle, 0));
	...
	private void initLeftImage(TypedArray ta, Context context) {
		// ta.getResources();
		leftImageSource = ta.getResourceId(R.styleable.barView_leftImageSourceTitle,
				R.drawable.ic_launcher);
		leftImagePadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftImagePaddingTitle, 0));
		leftImagePaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftImagePaddingLeftTitle, 0));
		leftImagePaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftImagePaddingRightTitle, 0));
		leftImagePaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftImagePaddingTopTitle, 0));
		leftImagePaddingBottom = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftImagePaddingBottomTitle, 0));
	}
	...
	private void initLeftText(TypedArray ta, Context context) {
		leftText = ta.getString(R.styleable.barView_leftTextTitle);
		System.out.println(leftText+">>>>>");
		if (leftText == null) {
			leftText = "请设置文字";
		}
		leftTextColor = ta.getColor(R.styleable.barView_leftTextColorTitle,
				Color.BLACK);

		leftTextSize = ta.getDimension(R.styleable.barView_leftTextSizeTitle, 14.0f);
		if (leftTextSize != 14.0f) {
			leftTextSize = DensityUtils.px2sp(context, leftTextSize);
		}
		// 默认为0
		leftTextPadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftTextPaddingTitle, 0));
		leftTextPaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftTextPaddingLeftTitle, 0));
		// System.out.println(leftTextPaddingLeft+"<><>");
		leftTextPaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftTextPaddingRightTitle, 0));
		leftTextPaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftTextPaddingTopTitle, 0));
		leftTextPaddingBottom = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftTextPaddingBottomTitle, 0));
	...
	private void initLeftButton(TypedArray ta, Context context) {
		leftButtonBg = ta.getResourceId(
				R.styleable.barView_leftButtonBackgroundTitle, Color.GRAY);
		leftButtonText = ta.getString(R.styleable.barView_leftButtonTextTitle);
		leftButtonTextColor = ta.getColor(
				R.styleable.barView_leftButtonTextColorTitle, Color.WHITE);
		leftButtonTextSize = ta.getDimension(
				R.styleable.barView_leftButtonTextSizeTitle, 12.0f);
		...
		leftButtonPadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonPaddingTitle, 0));
		leftButtonPaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonPaddingLeftTitle, 0));
		leftButtonPaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonPaddingRightTitle, 0));
		leftButtonPaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonPaddingTopTitle, 0));
		leftButtonPaddingBottom = DensityUtils
				.px2dp(context, ta.getDimension(
						R.styleable.barView_leftButtonPaddingBottomTitle, 0));

		leftButtonMargIn = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonMargInTitle, 0));
		leftButtonMargInLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonMargInLeftTitle, 0));
		leftButtonMargInRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonMargInRightTitle, 0));
		leftButtonMargInTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonMargInTopTitle, 0));
		leftButtonMargInBottom = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_leftButtonMargInBottomTitle, 0));
	}
	...
	private void initRightText(TypedArray ta, Context context) {
		rightText = ta.getString(R.styleable.barView_rightTextTitle);
		if (rightText == null) {
			rightText = "请设置文字";
		}
		rightTextColor = ta.getColor(R.styleable.barView_rightTextColorTitle,
				Color.BLACK);

		rightTextSize = ta.getDimension(R.styleable.barView_rightTextSizeTitle,
				14.0f);
		...
		rightTextPadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightTextPaddingTitle, 0));
		rightTextPaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightTextPaddingLeftTitle, 0));
		// System.out.println(leftTextPaddingLeft+"<><>");
		rightTextPaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightTextPaddingRightTitle, 0));
		rightTextPaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightTextPaddingTopTitle, 0));
		rightTextPaddingBottom = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightTextPaddingBottomTitle, 0));
	...
	private void initRightImage(TypedArray ta, Context context) {
		rightImageSource = ta.getResourceId(
				R.styleable.barView_rightImageSourceTitle, R.drawable.ic_launcher);
		rightImagePadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightImagePaddingTitle, 0));
		rightImagePaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightImagePaddingLeftTitle, 0));
		rightImagePaddingRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightImagePaddingRightTitle, 0));
		rightImagePaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightImagePaddingTopTitle, 0));
		rightImagePaddingBottom = DensityUtils
				.px2dp(context, ta.getDimension(
						R.styleable.barView_rightImagePaddingBottomTitle, 0));

	}

	private void initRightButton(TypedArray ta, Context context) {
		rightButtonBg = ta.getResourceId(
				R.styleable.barView_rightButtonBackgroundTitle, Color.GRAY);
		rightButtonText = ta.getString(R.styleable.barView_rightButtonTextTitle);
		rightButtonTextColor = ta.getColor(
				R.styleable.barView_rightButtonTextColorTitle, Color.WHITE);
		rightButtonTextSize = ta.getDimension(
				R.styleable.barView_rightButtonTextSizeTitle, 12.0f);
		...
		rightButtonPadding = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonPaddingTitle, 0));
		rightButtonPaddingLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonPaddingLeftTitle, 0));
		rightButtonPaddingRight = DensityUtils
				.px2dp(context, ta.getDimension(
						R.styleable.barView_rightButtonPaddingRightTitle, 0));
		rightButtonPaddingTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonPaddingTopTitle, 0));
		rightButtonPaddingBottom = DensityUtils.px2dp(context, ta.getDimension(
				R.styleable.barView_rightButtonPaddingBottomTitle, 0));

		rightButtonMargIn = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonMargInTitle, 0));
		rightButtonMargInLeft = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonMargInLeftTitle, 0));
		rightButtonMargInRight = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonMargInRightTitle, 0));
		rightButtonMargInTop = DensityUtils.px2dp(context,
				ta.getDimension(R.styleable.barView_rightButtonMargInTopTitle, 0));
		rightButtonMargInBottom = DensityUtils
				.px2dp(context, ta.getDimension(
						R.styleable.barView_rightButtonMargInBottomTitle, 0));
